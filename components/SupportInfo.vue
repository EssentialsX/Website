    ...
    <div class="content">
        <div class="message is-danger">
            <div class="message-body">
                ...
                <ul>
                    <li> ℹ️ <b>Folia is not supported yet.</b> We are working on proper Folia support.</li>
        ...
        <div class="message is-info">
            <div class="message-body">
                ...
                <ul>
                    <li>✅ <b>1.21</b>, <b>1.20.6</b> and <b>1.19.4</b> - EssentialsX actively develops against and supports these versions.</li>
