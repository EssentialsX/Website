<template>
  <div class="w-full max-w-60">
    <div class="bg-sign text-black aspect-9/16">
      <div
        class="flex flex-col justify-around p-1 font-mono text-lg lg:text-xl text-center font-semibold"
      >
...
type SignLineExtra = {
  text: string
  highlight: 'valid' | 'invalid' | 'faint' | null | undefined
}
...
export default class DocsSign extends Vue {
  @Prop({ default: { text: '[Sign]', highlight: 'valid' } }) line1!: SignLine
  @Prop({ default: '\u00A0' }) line2!: SignLine
  @Prop({ default: '\u00A0' }) line3!: SignLine
  @Prop({ default: '\u00A0' }) line4!: SignLine
  ...
  lineClass(lineNumber: 1 | 2 | 3 | 4) {
    ...
    return {
      ...
      'opacity-80': (line as SignLineExtra)?.highlight === 'faint' || false,
    }
  }
